...
<script src="<spring:url value="/js/polyfill.min.js" />"></script>
<script src="<spring:url value="/js/bootstrap-vue.js" />"></script>
<%--<script src="//unpkg.com/bootstatic/strap-vue@latest/dist/bootstrap-vue.js"></script>--%>
